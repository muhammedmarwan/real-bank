...
### Qbox Notes
- Import [`real-bank.sql`](real-bank.sql) into the same database used by `qbx_core`.
- Ensure `qbx_core`, `ox_lib`, `ox_target`, and `oxmysql` are started before this resource.
